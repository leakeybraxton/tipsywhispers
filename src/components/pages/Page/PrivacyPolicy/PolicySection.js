      ...
      <Container>
        <div className="Policy">
          <div className="PolicyImg">
            <img src={img1} className="mx-auto img-fluid" alt="policy"/>
          </div>
          ...
          <div>
            ...
            <div className="PolicyContent">
              ...
              To stop receiving promotional communications from us, you can
                  ...
                  confirmations, order confirmations, important updates about
                  the Services, and notices about our policies.
              </p>
