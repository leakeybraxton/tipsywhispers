  ...
  return(
        <>
              <div className="DLearing-left-Content">
                    ...
                    <h1>
                      Flexible Study at Own Pace, According to Your Own Needs
                    </h1>
                    <p>
                      With the eCademy, you can study whenever and wherever you
                      choose. We have students in over 175 countries and a
                      global reputation as a pioneer in the field of flexible
                      learning. Our teaching also means, if you travel often or
                      need to relocate, you can continue to study wherever you
                      go.
                    </p>
                  </div>
                      ...
                      <div>
                        ...
                        <div className="DLearingSlider">
                            <p className="DLSlider-Content">
                              Lorem Ipsum is simply dummy text of the when an
                              unknown printer took a galley of type and
                              scrambled it to make a type specimen book. It has
                              surviv with the release of Letraset sheets
                              containing Lorem Ipsum and more recently with
                              desktop publishing software like PageMaker
