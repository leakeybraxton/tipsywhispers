                ...
                <div className="Single-Course-tabs ">
                  <ul className="list-unstyled Stab-menu flex-wrap  active">
                    <li>
                      <button
                        className={
                          toggleState === 1 ? "Stabs active-Stabs" : "Stabs"
                        }
                        onClick={() => toggleTab(1)}
                      >
                        Overview
                    ...
                    <li>
                      <button
                        className={
                          toggleState === 2 ? "Stabs active-Stabs" : "Stabs"
                        }
                        onClick={() => toggleTab(2)}
                      >
                        Curriculum
                    ...
                    <li>
                      <button
                        className={
                          toggleState === 3 ? "Stabs active-Stabs" : "Stabs"
                        }
                        onClick={() => toggleTab(3)}
                      >
                        Instructor
                    ...
                    <li>
                      <button
                        className={
                          toggleState === 4 ? "Stabs active-Stabs" : "Stabs"
                        }
                        onClick={() => toggleTab(4)}
                      >
                        Reviews
                  ...
                  >
                    <div className="Instructor">
                      ...
                      <div className="Instructor-text">
                        <span>Jone Smit</span>
                        <p>
                          Jone Smit is a celebrated photographer, author, and
